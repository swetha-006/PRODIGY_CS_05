...
base.title("Network Packet Sniffer")

head_frame = Frame(base)
head_frame.pack(side=TOP, anchor="center", pady=10)

head_label = Label(head_frame, text="Network Packet Sniffer", font=("Times New Roman", 20, "bold"))
head_label.grid(row=0, column=0)

author_label = Label(head_frame, text="Author: Cyber punk", font=("Times New Roman", 15, "bold"))
